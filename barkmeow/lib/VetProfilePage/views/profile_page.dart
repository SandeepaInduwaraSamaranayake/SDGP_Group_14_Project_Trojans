      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const CardViewSingleLabel(cardName: 'Ranathunga'),
            ...
            const CardViewDoubleLabel(
                title: 'Change Number', value: '+94718606080'),
            const CardViewDoubleLabel(title: 'Username', value: '@dr.minura'),
            SizedBox(height: sizeV * 2),
            InkWell(
              onTap: () {
                // Navigator.push(
            ...
            SizedBox(height: sizeV * 2),
            Text(
              'ID verification will take 3-5 Business days.',
              style: profileGreyInstructions,
            ),
            SizedBox(
              height: sizeV * 2,
